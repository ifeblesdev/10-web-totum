...
export const groupFields = [
  ...
  },
  {
    ...
    type: "checkbox",
    tooltip: "Marque si es un acompañamiento y/o contorno",
    order: 5,
  },
  {
    name: "same_screen",
    ...
    type: "checkbox",
    tooltip: "Marque si permanece en la misma pantalla al ser seleccionado",
    order: 10,
  },
  {
    name: "show_order",
    label: "Se muestra en la orden",
    type: "checkbox",
    tooltip: "Marque si se muestra en la orden al ser seleccionado",
    order: 15,
  },
  {
    name: "disable",
    label: "Desactivado",
    type: "checkbox",
    tooltip: "Indica si el grupo está desactivado",
    order: 20,
  },
];
