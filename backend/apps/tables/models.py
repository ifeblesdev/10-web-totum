...
class Table(models.Model):
    ...
    printer_commands1 = models.ForeignKey('printers.Printer', on_delete=models.PROTECT, related_name='printer_commands1', null=True, blank=True)
    printer_commands2 = models.ForeignKey('printers.Printer', on_delete=models.PROTECT, related_name='printer_commands2', null=True, blank=True)
    environment = models.ForeignKey('environments.Environment', on_delete=models.PROTECT)
    table_type = models.ForeignKey('tabletypes.TableType', on_delete=models.PROTECT, null=True, blank=True)
