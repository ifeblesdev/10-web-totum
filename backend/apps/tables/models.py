...
class Table(models.Model):
    ...
    environment_id = models.ForeignKey('environments.Environment', on_delete=models.CASCADE, null=True, blank=True)
    table_type_id = models.ForeignKey('tabletypes.TableType', on_delete=models.CASCADE, null=True, blank=True)
